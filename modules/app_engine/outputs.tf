...
output "name" {
  ...
  value       = google_app_engine_application.app-example-yogita.name
}

output "url_dispatch_rule" {
  description = "A list of dispatch rule blocks. Each block has a domain, path, and service field."
  value       = google_app_engine_application.app-example-yogita.url_dispatch_rule
}

output "code_bucket" {
  description = "The GCS bucket code is being stored in for this app."
  value       = google_app_engine_application.app-example-yogita.code_bucket
}

output "default_hostname" {
  description = "The default hostname for this app."
  value       = google_app_engine_application.app-example-yogita.default_hostname
}

output "default_bucket" {
  description = "The GCS bucket content is being stored in for this app."
  value       = google_app_engine_application.app-example-yogita.default_bucket
}

output "location_id" {
  description = "The location app engine is serving from"
  value       = google_app_engine_application.app-example-yogita.location_id
}
